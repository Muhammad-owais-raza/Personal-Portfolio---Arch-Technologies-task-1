...
1. Double-click `index.html` in your file explorer to launch it directly in Google Chrome, Mozilla Firefox, Microsoft Edge, Safari, or any modern web browser.
2. Alternatively, open the directory in VS Code and use the *Live Server* extension.
